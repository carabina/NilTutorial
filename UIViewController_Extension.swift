...
//  Pods
//
//  Created by Tanasak Ngerniam on 9/12/2560 BE.
//
//
...
public extension UIViewController {
    ...
    func configureChildViewController(childController: UIViewController, onView: UIView?, withFadeAnimate: Bool = false, animateDuration: Double = 0.2) {
